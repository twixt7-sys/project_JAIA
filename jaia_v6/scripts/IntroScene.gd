...
@onready var TITLE_SCREEN_SCENE: PackedScene = preload("res://scenes/TitleScreen.tscn")
@onready var ABOUT_SCREEN_SCENE: PackedScene = preload("res://scenes/AboutScreen.tscn")
